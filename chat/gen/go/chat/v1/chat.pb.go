...
func (x *ChatChunk) GetAgentId() string {
	if x != nil {
		return x.AgentId
	}
	return ""
...
func (x *ChatChunk) GetEvent() string {
	if x != nil {
		return x.Event
	}
	return ""
...
const file_chat_v1_chat_proto_rawDesc = "" +
	"\n" +
	"\x12chat/v1/chat.proto\x12\achat.v1\"\x98\x01\n" +
	"\vChatRequest\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12\x19\n" +
	"\x05model\x18\x03 \x01(\tH\x00R\x05model\x88\x01\x01\x12\x1e\n" +
	"\bagent_id\x18\x04 \x01(\tH\x01R\aagentId\x88\x01\x01B\b\n" +
	"\x06_modelB\v\n" +
	"\t_agent_id\"\xaa\x01\n" +
	"\tChatChunk\x12\x1d\n" +
	"\n" +
	...
	"\x05event\x18\x06 \x01(\tR\x05eventB\b\n" +
	"\x06_error\"\x15\n" +
	...
	"\fListSessions\x12\x1c.chat.v1.ListSessionsRequest\x1a\x1d.chat.v1.ListSessionsResponseB\x90\x01\n" +
	"\vcom.chat.v1B\tChatProtoP\x01Z9github.com/Suizer98/potato-merch-ai/gen/go/chat/v1;chatv1\xa2\x02\x03CXX\xaa\x02\aChat.V1\xca\x02\aChat\\V1\xe2\x02\x13Chat\\V1\\GPBMetadata\xea\x02\bChat::V1b\x06proto3"
...
var file_chat_v1_chat_proto_depIdxs = []int32{
	...
	1, // 3: chat.v1.ChatService.Chat:output_type -> chat.v1.ChatChunk
	3, // 4: chat.v1.ChatService.ListSessions:output_type -> chat.v1.ListSessionsResponse
